...
import { EASTERN_TZ, parseTimestamp } from '../lib/dates.js';
...
function formatDateTime(d) {
  ...
  if (Number.isNaN(dt.getTime())) return d;
  return dt.toLocaleString('en-US', { year: 'numeric', month: 'short', day: 'numeric', hour: 'numeric', minute: '2-digit', timeZone: EASTERN_TZ });
}
