...
// starting point. (This list previously had category-specific defaults like "1 Year" for
// TRN-012 First Aid/CPR/AED - those are gone now per that decision, not an oversight.)
...
const MASTER_TRAININGS = [
  ...
  ['TRN-005', 'Hazard Communication (HAZCOM)', 'Safety', 'Training', 'None'],
  ['TRN-006', 'Fall Protection', 'Safety', 'Training', 'None'],
  ['TRN-007', 'Ladder Safety', 'Safety', 'Training', 'None'],
  ['TRN-008', 'Trenching & Excavation', 'Safety', 'Training', 'None'],
  ['TRN-009', 'Confined Space', 'Safety', 'Training', 'None'],
  ['TRN-010', 'Lockout/Tagout (LOTO)', 'Safety', 'Training', 'None'],
  ['TRN-011', 'Focus Five', 'Safety', 'Training', 'None'],
  ['TRN-012', 'First Aid / CPR / AED', 'Medical/Emergency', 'Training', 'None'],
  ['TRN-013', 'Bloodborne Pathogens', 'Medical/Emergency', 'Training', 'None'],
  ['TRN-014', 'Respiratory Protection', 'Safety', 'Training', 'None'],
  ['TRN-015', 'Respirator Fit Testing', 'Safety', 'Fit Test', 'None'],
  ...
  ['TRN-038', 'Skid Steer Operator', 'Equipment', 'Certification', 'None'],
  ['TRN-039', 'Dump Truck', 'Equipment', 'Training', 'None'],
  ['TRN-040', 'Crane Safety', 'Equipment', 'Training', 'None'],
  ['TRN-041', 'Qualified Rigger', 'Rigging', 'Certification', 'None'],
  ['TRN-042', 'Qualified Signalperson', 'Rigging', 'Certification', 'None'],
  ['TRN-043', 'Utility Strike Avoidance Planning (USAP)', 'Safety', 'Training', 'None'],
  ['TRN-044', 'Demolition/Rework', 'Safety', 'Training', 'None'],
